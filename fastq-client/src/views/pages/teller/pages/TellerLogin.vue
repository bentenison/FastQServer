<template>
  <v-app id="lock">
    <div class="container h-100 mt-5" :key="activated">
      <div
        class="row d-flex flex-row align-items-center justify-content-center mt-5"
        v-if="activated"
      >
        <div class="col-md-5 py-5">
          <v-card elevation="10">
            <v-card-title
              ...
              v-if="this.activeCounter.CounterName"
            >
      ...
      >
        <div
          class="row col-md-8 d-flex align-items-center justify-content-center"
        >
            ...
            <div class="row">
              <div class="col-md-12 mt-5">
                ...
                >
                  ...
                  <v-btn class="mr-3" color="primary" @click="activateCounter"
  ...
  methods: {
    ...
    activateCounter() {
      return new Promise((resolve, reject) => {
        ...
        if (
          !this.clientDetails ||
          !this.clientDetails.client_cpu === "" ||
          !this.clientDetails.client_disk_id === ""
        ) {
        ...
        axios
          .post(`/license/counteractivate`, payload)
          .then((res) => {
            console.log("res:::::", res);
    ...
    checkCounter() {
      return new Promise((resolve, reject) => {
        ...
        axios
          .post(`/app/checkandgetcounter`, payload)
          .then((res) => {
            console.log("res:::::", res);
    ...
    getAllCounters() {
      ...
      axios
        .get(
          `/counter/getinactivecounter/${this.$store.state.Auth.user.company_code}`
        )
        .then((res) => {
          console.log(">>>>>>>>>>>>>>>>>", res);
    ...
    counterlogin() {
      return new Promise((resolve, reject) => {
        ...
        axios
          .post(`/counter/auth`, this.counterUser)
          .then((res) => {
            console.log("res:::::", res);
            this.user = res.data;
          ...
          .catch((err) => {
            ...
            if (err.response.status === 401) {
              ...
              this.$toast.error(
                "error occured while authenticating counter!!!"
              );
            }
            reject(err.response);
          });
