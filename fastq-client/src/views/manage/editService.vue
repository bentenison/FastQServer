    ...
    <div class="row h-100">
      <div class="row col-md-12 h-100">
          ...
          <div class="row">
            <div class="col-md-12 mt-5">
              ...
              <div class="col-md-12 d-flex flex-wrap">
                ...
                <v-col cols="12" sm="3" class="">
                  <v-checkbox
                    v-model="service.ShowDisplay"
                    label="Show in Ticket Display"
                    color="primary"
                    class=""
                    :value="true"
                    hide-details
        ...
        <div class="row col-md-12">
          <v-expansion-panels v-model="panel" multiple flat style="z-index: 10">
            <v-expansion-panel>
  ...
  methods: {
    ...
    updateService() {
      let payload = {
        ...
        number_starts: parseInt(this.service.NumberStarts),
        number_ends: parseInt(this.service.NumberEnds),
        hide: this.service.Hide,
      ...
      axios
        ...
        .catch((err) => {
          console.log(err.response);
          this.$toast.error("error occured while updating service!!!");
        });
    },
  },
