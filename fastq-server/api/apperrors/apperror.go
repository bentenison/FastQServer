...
const (
	...
	ExpectationFailed       Type = "EXPECTATION_FAILED"     // for http 417
	ErrorPasswordMismatched Type = "PASSWORD_MISMATCH"      // for http 417
)

var PasswordMismatched = errors.New("password mismatched !!")
...
// 417
func NewExpectationFailed(reason string) *Error {
	return &Error{
		Type:    ExpectationFailed,
		Message: reason,
	}
}
func NewPasswordError(reason string) *Error {
	return &Error{
		Type:    ErrorPasswordMismatched,
		Message: reason,
	}
}
